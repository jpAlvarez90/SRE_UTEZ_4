...
@WebServlet(name = "ServletRegistrarReservaciones")
public class ServletRegistrarReservaciones extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/vista/jsp/administrativo/aceptar_rechazar_reservaciones/RealizarReservaciones.jsp").forward(request, response);
